    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                ...
                entity.Property(e => e.Clave).HasMaxLength(255).IsRequired();
                entity.Property(e => e.Email).HasMaxLength(150).IsRequired();
                entity.HasIndex(e => e.Email).IsUnique();
                entity.Property(e => e.Dni).HasMaxLength(20).IsRequired();
                entity.HasIndex(e => e.Dni).IsUnique();
                entity.Property(e => e.FechaAlta).HasColumnType("datetime").IsRequired();
            ...
            modelBuilder.Entity<Precio>(entity =>
            {
                ...
                entity.Property(e => e.Valor).HasColumnName("precio").HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity<Favorito>(entity =>
            {
                ...
                entity.Property(e => e.FechaAgregado).HasColumnType("datetime").IsRequired();
